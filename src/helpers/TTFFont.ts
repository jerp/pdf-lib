...
// import { textOptions, Subset } from 'helpers/Font'
...
} from 'helpers/TTFTables/DirectoryTypes';

/**
 * Decoding a TTF font, subset encoding
 */
export class TTFFont {
  ...
  encodeSubset(subsetMap: number[]) {
    ...
    directoryFactory.encodeTable('glyf', directory.glyf, subsetMap)
    directoryFactory.encodeTable('head', directory.head, subsetMap)
    // loca must be after head as head.indexToLocFormat depends on length of largest loca offset
    directoryFactory.encodeTable('loca', directory.loca, subsetMap)
    directoryFactory.encodeTable('hhea', directory.hhea, subsetMap)
    directoryFactory.encodeTable('maxp', directory.maxp, subsetMap)
    directoryFactory.encodeTable('cvt ', directory.cvt, subsetMap)
    directoryFactory.encodeTable('prep', directory.prep, subsetMap)
    directoryFactory.encodeTable('hmtx', directory.hmtx, subsetMap)
    directoryFactory.encodeTable('fpgm', directory.fpgm, subsetMap)
